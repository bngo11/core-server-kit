...
EGO_SUM=(
	...
	"github.com/!azure/azure-sdk-for-go/sdk/storage/azblob v1.7.0/go.mod"
	...
	"github.com/!google!cloud!platform/opentelemetry-operations-go/detectors/gcp v1.31.0/go.mod"
	...
	"github.com/elithrar/simple-scrypt v1.4.1/go.mod"
	...
	"github.com/minio/minio-go/v7 v7.1.0/go.mod"
	...
	"github.com/peterbourgon/unixtransport v0.0.7/go.mod"
	...
	"github.com/tinylib/msgp v1.6.1/go.mod"
	...
	"google.golang.org/api v0.282.0/go.mod"
