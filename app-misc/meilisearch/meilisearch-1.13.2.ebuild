...
SRC_URI="
	https://github.com/meilisearch/meilisearch/tarball/296ca1d58f25d8d8c5f8a03fc1ded189882c47b5 -> meilisearch-1.13.2-296ca1d.tar.gz
	https://direct.funtoo.org/0b/4a/3e/0b4a3e03b96e1243321a5e36a49bdc252efc22484298991cd0a3b98b0712ed465efeabb7d319034acc0d095ec3dc2d70f77bb581efde08dcbe3d3cc4adaa8a1b -> meilisearch-1.13.2-funtoo-crates-bundle-62098aaa9204acbe54612f5024a67a3b1a277fbc88e076bc13df0d0b60424d23368537e6bcd648816d4c0913fa2d056e4c715bfc56b0bd3d508e6de00a54090a.tar.gz
	https://dotsrc.dl.osdn.net/osdn/unidic/58338/unidic-mecab-2.1.2_src.zip -> unidic-mecab-2.1.2_src.zip
	mini-dashboard? ( https://github.com/meilisearch/mini-dashboard/releases/download/v0.2.17/build.zip -> meilisearch-mini-dashboard-29e92ce25f306208a9c86f013279c736bdc1e034.zip )
"
...
src_prepare() {
	...
	if use mini-dashboard; then
		...
		sed -i "s|https://github.com/meilisearch/mini-dashboard/releases/download/v0.2.17/build.zip|${DISTDIR}/meilisearch-mini-dashboard-29e92ce25f306208a9c86f013279c736bdc1e034.zip|g" "${S}"/meilisearch/Cargo.toml
